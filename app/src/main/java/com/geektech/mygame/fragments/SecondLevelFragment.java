...
import com.geektech.mygame.databinding.FragmentSecondLevelBinding;
...
public class SecondLevelFragment extends Fragment implements Contracts.CounterView {

    FragmentSecondLevelBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentSecondLevelBinding.inflate(inflater);
    ...
    private void initSet() {
        binding.btnSet.setOnClickListener(v -> {
            ...
            presenter.LetsCheckSpiral(answer);
        });
